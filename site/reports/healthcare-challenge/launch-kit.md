...
I built Honeypot Med, an open-source prompt-injection honeypot for healthcare AI
...
Project site: https://byteworthyllc.github.io/honeypot-med/
Install and releases: https://byteworthyllc.github.io/honeypot-med/releases/
Repository: https://github.com/ByteWorthyLLC/honeypot-med


## Install

- Releases page: https://byteworthyllc.github.io/honeypot-med/releases/
- macOS / Linux: `curl -fsSL https://raw.githubusercontent.com/ByteWorthyLLC/honeypot-med/main/scripts/bootstrap/install.sh | bash`
- Windows: `powershell -ExecutionPolicy Bypass -Command "iwr https://raw.githubusercontent.com/ByteWorthyLLC/honeypot-med/main/scripts/bootstrap/install.ps1 -UseBasicParsing | iex"`

## Keywords

prompt injection healthcare AI, prompt injection honeypot, healthcare AI security, local-first AI security tool, open source prompt security, healthcare LLM red team
...
No. The default path is local-first and works without API keys.
