...
def write_challenge_bundle(
    ...
    *,
    ...
    bundle["extra_artifacts"] = {
        ...
        "proof_dossier_html": bundle.get("proof_dossier_html_path", str(bundle_dir / "proof-dossier.html")),
        "proof_dossier_pdf": bundle.get("proof_dossier_pdf_path", str(bundle_dir / "offline-proof.pdf")),
        "ui_mockup": bundle.get("ui_mockup_path", str(bundle_dir / "ui-mockup.html")),
